...
--
-- Host: 127.0.0.1    Database: dbcontrolinventariopro
-- ------------------------------------------------------
...
INSERT INTO `categorias` VALUES (1,'General','Categoría por defecto','ACTIVO'),(2,'daye','derfddxccvcielito\r\n','INACTIVO'),(3,'waaaa','waza','ACTIVO');
...
CREATE TABLE `movimientos` (
  ...
  KEY `FKhlhhv82oj64xasbmrg5msjkx1` (`idproducto`),
  CONSTRAINT `FKhlhhv82oj64xasbmrg5msjkx1` FOREIGN KEY (`idproducto`) REFERENCES `productos` (`idproducto`)
...
INSERT INTO `movimientos` VALUES (1,65,NULL,'ENTRADA',3),(2,926,NULL,'ENTRADA',3),(3,850,NULL,'SALIDA',3),(4,1350,NULL,'ENTRADA',3),(5,1350,'2025-12-11 18:43:44.722000','SALIDA',3),(6,1350,'2025-12-15 16:54:51.362000','ENTRADA',3),(7,20,'2025-12-15 16:55:01.193000','ENTRADA',1);
...
CREATE TABLE `productos` (
  ...
  KEY `FKnt1uy54bd87uyxc66wv7b92ip` (`idproveedor`),
  CONSTRAINT `fk_producto_categoria` FOREIGN KEY (`idcategoria`) REFERENCES `categorias` (`idcategoria`),
  CONSTRAINT `FKnt1uy54bd87uyxc66wv7b92ip` FOREIGN KEY (`idproveedor`) REFERENCES `proveedores` (`idproveedor`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `productos` VALUES (1,1,'eee','sfdsdfsdf',10.00,120,'https://i.pinimg.com/736x/4f/01/67/4f0167d0418ad8032247abe3d46a25bf.jpg','ACTIVO','2025-11-26 18:30:57',1),(2,1,'eee','sdfsdf',10.00,100,'https://i.pinimg.com/736x/4f/01/67/4f0167d0418ad8032247abe3d46a25bf.jpg','ACTIVO','2025-11-26 18:33:19',2),(3,3,'DARKQTP','fdfddfdf',100.00,1500,'uploads/Gemini_Generated_Image_fx14gkfx14gkfx14.png','ACTIVO','2025-12-11 06:45:15',1);
...
INSERT INTO `proveedores` VALUES (1,'6226','Jirón Contamana\r\nMercado mayorista Terminal KM.6, Yarinacocha, Jr. 7 de Junio #222','speedaep655@gmail.com','ACTIVO',NULL,'Pepito','94966777'),(2,'6226','gfhgfhfghf','grupoperuanatecnology@grupoperuana.pe','ACTIVO',NULL,'Grupo Peruana','94966777');
...
INSERT INTO `usuarios` VALUES (5,'admin','admin123','Administrador del Sistema','admin@example.com','ADMIN','ACTIVO','2025-12-10 23:57:29');
/*!40000 ALTER TABLE `usuarios` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'dbcontrolinventariopro'
--
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_contarCategorias` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_contarCategorias`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_contarProductos` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_contarProductos`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_contarStockBajo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_contarStockBajo`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_contarUsuarios` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_contarUsuarios`()
BEGIN
...
BEGIN
    INSERT INTO productos (idcategoria, nombre, descripcion, precio, stock, imagen)
    VALUES (p_idcategoria, p_nombre, p_descripcion, p_precio, p_stock, p_imagen);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    SELECT 
        ...
        p.stock, 
        p.imagen, 
        p.estado,   -- Aquí quitamos el alias "as estado_producto"
        p.fecha_creacion, 
...
-- Dump completed on 2025-12-24 21:37:44
